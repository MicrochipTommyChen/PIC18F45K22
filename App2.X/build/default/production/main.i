...
# 117 "./mcc_generated_files/pin_manager.h"
...
{
    FLASH_WriteByte(0x8000 - 1, Buf, 0x00);
    FLASH_WriteByte(0x8000 - 2, Buf, 0x00);
}

void EraseResetVector ()
{
    FLASH_WriteByte(0x0500, Buf, 0x00);
    FLASH_WriteByte(0x0500 + 1, Buf, 0x00);
}
